...
const UnitConversionQuiz = ({ question, selectOption, animatedValues, comparisonAnswer, setComparisonAnswer, comparisonAnswerRef, buttonRefs }) => {
  ...
  return (
    <View>
      <View style={styles.questionContainer}>
        <Text style={styles.greetingText}>Rechne in die nächst kleinere Einheit um.</Text>
      </View>
      <View style={styles.comparisonQuestion}>
        <Text style={styles.comparisonText}>{question.question}</Text>
...
export default UnitConversionQuiz;
