...
const ScheduleQuiz = ({ question, selectOption, animatedValues, comparisonAnswer, setComparisonAnswer, comparisonAnswerRef, buttonRefs }) => {
  ...
  return (
    <View>
      <View style={styles.scheduleImagesContainerAligned}>
        <Image source={question.imageLeft} style={styles.scheduleImage} />
        <Image source={question.imageRight} style={styles.scheduleImage} />
      </View>
      <Text style={styles.questionSchedule}>{question.question}</Text>
      <View style={styles.comparisonQuestion}>
        <Text style={styles.comparisonText}>{question.question2part1}</Text>
        ...
        <Text style={styles.comparisonText}>{question.question2part2}</Text>
      </View>
